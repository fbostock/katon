...
public class IntegerEditor extends DefaultCellEditor {
    ...
    public static IntegerEditor of(int min, int max) {
        return new IntegerEditor(new JFormattedTextField(), min, max);
    }

    public IntegerEditor(JFormattedTextField textField, int min, int max) {
        super(textField);
        ftf = textField;
        minimum = min;
        maximum = max;
